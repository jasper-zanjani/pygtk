...
class assistant(Gtk.Assistant):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Page 0
        page0_widget = Gtk.Label(label="This in an example of a Gtk.Assistant. By\nclicking the forward button, you can continue\nto the next section!")
        ...
        label = Gtk.Label(label="Your Name: ")
        entry = Gtk.Entry(text="World")
        ...
        self.set_page_complete(page1_widget, True)
        
        # Page 2
        page2_widget = Gtk.CheckButton.new_with_label("Click me to Continue!")
        page2_widget.set_active(True)
        ...
        self.set_page_complete(page2_widget, True)
        
        # Page 3
        page3_widget = Gtk.Box(orientation=Gtk.Orientation.VERTICAL, spacing=10)
        ...
        # Page 4
        page4_widget = Gtk.Label(label="Text has been entered in the label and the\ncombo box is clicked. If you are done, then\nit is time to leave!")
